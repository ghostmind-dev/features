...
DEVCONTAINER_EXTENSIONS=${DEVCONTAINEREXTENSIONS:-"false"}
...
echo "    DEVCONTAINEREXTENSIONS=\"${DEVCONTAINER_EXTENSIONS}\""
...
set_env_var "INIT_DEVCONTAINER_EXTENSIONS" "${DEVCONTAINER_EXTENSIONS}"
